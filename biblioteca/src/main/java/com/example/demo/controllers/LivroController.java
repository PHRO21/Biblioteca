...
public class LivroController {
	...
	public LivroOutput criaLivro(@Valid @RequestBody LivroInput livro) {
		...
		converteAutores(livro, livroEntity);
	...
	public LivroOutput alteraLivro(@PathVariable Long id, @Valid @RequestBody LivroInput livroInput) {
		...
		livroConvert.copyInputToEntity(livroInput, livroEntity);

		converteAutores(livroInput, livroEntity);
	...
	private void converteAutores(LivroInput livro, LivroEntity livroEntity) {
