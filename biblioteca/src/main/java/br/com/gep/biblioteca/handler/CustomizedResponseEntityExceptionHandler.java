...
import br.com.gep.biblioteca.exceptions.BadRequestBussinessException;
import br.com.gep.biblioteca.exceptions.NotFounBussinessException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NotFounBussinessException.class)
    public final ResponseEntity<ProblemExceptionOutput> handlerNotFoundBussinessException(NotFounBussinessException ex,
            WebRequest request) {
